      ...
      <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between space-y-3">
        <div>
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-sm sm:text-base font-black text-white group-hover:text-emerald-400 transition truncate">
              {game.name}
            </h3>
            {game.primary_color && (
              <span
          ...
          <p className="text-[11px] sm:text-xs text-zinc-400 line-clamp-2 mt-1 leading-snug">
            {game.description}
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 pt-1">
          ...
          <Link
            ...
            className="p-2 rounded-xl bg-dark-850 hover:bg-dark-800 border border-white/10 hover:border-emerald-500/30 text-zinc-300 hover:text-white text-xs transition"
